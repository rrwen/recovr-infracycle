...
* [vancouver-bikeways-preprocess-v2.geojson](https://github.com/rrwen/recovr-infracycle/blob/main/data/vancouver-bikeways-preprocess-v2.geojson)
* [vancouver-bikeways-preprocess-v2.csv](https://github.com/rrwen/recovr-infracycle/blob/main/data/vancouver-bikeways-preprocess-v2.csv)
...
# Save geojson
vanc_preprocess %>%
	write_sf("../data/vancouver-bikeways-preprocess-v2.geojson", delete_dsn = TRUE)

# Save csv
# st_read("../data/vancouver-bikeways-preprocess-v2.csv", options = "GEOM_POSSIBLE_NAMES=geometry", crs = "urn:ogc:def:crs:OGC:1.3:CRS84")
vanc_preprocess %>%
	mutate(
		geometry = st_as_text(geometry),
	...
	write_csv("../data/vancouver-bikeways-preprocess-v2.csv", na = "")
...
vanc_preprocess %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "vancouver-bikeways-preprocess-nonspatial-v2")
```
...
* [calgary-bikeways-preprocess-v3.geojson](https://github.com/rrwen/recovr-infracycle/blob/main/data/calgary-bikeways-preprocess-v3.geojson)
* [calgary-bikeways-preprocess-v3.csv](https://github.com/rrwen/recovr-infracycle/blob/main/data/calgary-bikeways-preprocess-v3.csv)
...
# Save geojson
calg_preprocess %>%
	write_sf("../data/calgary-bikeways-preprocess-v3.geojson", delete_dsn = TRUE)

# Save csv
# st_read("../data/calgary-bikeways-preprocess-v3.csv", options = "GEOM_POSSIBLE_NAMES=geometry", crs = "urn:ogc:def:crs:OGC:1.3:CRS84")
calg_preprocess %>%
	mutate(
		geometry = st_as_text(geometry),
	...
	write_csv("../data/calgary-bikeways-preprocess-v3.csv", na = "")
...
calg_preprocess %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "calgary-bikeways-preprocess-nonspatial-v3")
```
...
* [toronto-bikeways-preprocess-v3.geojson](https://github.com/rrwen/recovr-infracycle/blob/main/data/toronto-bikeways-preprocess-v3.geojson)
* [toronto-bikeways-preprocess-v3.csv](https://github.com/rrwen/recovr-infracycle/blob/main/data/toronto-bikeways-preprocess-v3.csv)
...
# Save geojson
toron_preprocess %>%
	write_sf("../data/toronto-bikeways-preprocess-v3.geojson", delete_dsn = TRUE)

# Save csv
# st_read("../data/toronto-bikeways-preprocess-v3.csv", options = "GEOM_POSSIBLE_NAMES=geometry", crs = "urn:ogc:def:crs:OGC:1.3:CRS84")
toron_preprocess %>%
	mutate(
		geometry = st_as_text(geometry),
	...
	write_csv("../data/toronto-bikeways-preprocess-v3.csv", na = "")
...
toron_preprocess %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "toronto-bikeways-preprocess-nonspatial-v3")
```
...
**Note**: Only meaasures from the bikeway data is calculated here.
