...
vanc_raw <- read_sf("../data/raw/vancouver/Vancouver AS KS Mar26.shp") %>%
	left_join( # Add corrections for verified bikeways
	...
	mutate( # Correct for missing verified bikeways
...
* [calgary-bikeways-raw-v2.geojson](https://github.com/rrwen/recovr-infracycle/blob/main/data/calgary-bikeways-raw-v2.geojson)
* [calgary-bikeways-raw-v2.csv](https://github.com/rrwen/recovr-infracycle/blob/main/data/calgary-bikeways-raw-v2.csv)
...
# Save geojson
calg_raw %>%
	write_sf("../data/calgary-bikeways-raw-v2.geojson", delete_dsn = TRUE)
...
calg_raw %>%
	...
	write_csv("../data/calgary-bikeways-raw-v2.csv", na = "")
...
calg_raw %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "calgary-bikeways-raw-nonspatial-v2")
```
...
* [toronto-bikeways-raw-v2.geojson](https://github.com/rrwen/recovr-infracycle/blob/main/data/toronto-bikeways-raw-v2.geojson)
* [toronto-bikeways-raw-v2.csv](https://github.com/rrwen/recovr-infracycle/blob/main/data/toronto-bikeways-raw-v2.csv)
...
# Save geojson
toron_raw %>%
	write_sf("../data/toronto-bikeways-raw-v2.geojson", delete_dsn = TRUE)
...
toron_raw %>%
	...
	write_csv("../data/toronto-bikeways-raw-v2.csv", na = "")
...
toron_raw %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "toronto-bikeways-raw-nonspatial-v2")
```
...
* [calgary-bikeways-preprocess-v2.geojson](https://github.com/rrwen/recovr-infracycle/blob/main/data/calgary-bikeways-preprocess-v2.geojson)
* [calgary-bikeways-preprocess-v2.csv](https://github.com/rrwen/recovr-infracycle/blob/main/data/calgary-bikeways-preprocess-v2.csv)
...
# Save geojson
calg_preprocess %>%
	write_sf("../data/calgary-bikeways-preprocess-v2.geojson", delete_dsn = TRUE)

# Save csv
# st_read("../data/calgary-bikeways-preprocess-v2.csv", options = "GEOM_POSSIBLE_NAMES=geometry", crs = "urn:ogc:def:crs:OGC:1.3:CRS84")
calg_preprocess %>%
	mutate(
		geometry = st_as_text(geometry),
	...
	write_csv("../data/calgary-bikeways-preprocess-v2.csv", na = "")
...
calg_preprocess %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "calgary-bikeways-preprocess-nonspatial-v2")
```
...
* [toronto-bikeways-preprocess-v2.geojson](https://github.com/rrwen/recovr-infracycle/blob/main/data/toronto-bikeways-preprocess-v2.geojson)
* [toronto-bikeways-preprocess-v2.csv](https://github.com/rrwen/recovr-infracycle/blob/main/data/toronto-bikeways-preprocess-v2.csv)
...
# Save geojson
toron_preprocess %>%
	write_sf("../data/toronto-bikeways-preprocess-v2.geojson", delete_dsn = TRUE)

# Save csv
# st_read("../data/toronto-bikeways-preprocess-v2.csv", options = "GEOM_POSSIBLE_NAMES=geometry", crs = "urn:ogc:def:crs:OGC:1.3:CRS84")
toron_preprocess %>%
	mutate(
		geometry = st_as_text(geometry),
	...
	write_csv("../data/toronto-bikeways-preprocess-v2.csv", na = "")
...
toron_preprocess %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "toronto-bikeways-preprocess-nonspatial-v2")
```
...
calg %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "calgary-bikeways-preprocess-filter-v2")
```
...
toron %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable("filename = toronto-bikeways-preprocess-filter-v2")
```
