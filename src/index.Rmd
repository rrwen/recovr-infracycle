...
vanc_raw <- read_sf("../data/raw/vancouver/Vancouver AS KS Mar26.shp") %>%
	left_join( # Add corrections for verified bikeways
		...
		by = join_by(object_id == id),
		keep = T
	) %>%
	mutate( # Correct for missing verified bikeways
		FROM_STR = if_else(!is.na(id), street_from, FROM_STR),
		TO_STR = if_else(!is.na(id), street_to, TO_STR),
		INST_YR = if_else(!is.na(id), verify_install_year, INST_YR),
		INST_TMIN = if_else(!is.na(id), verify_install_type, INST_TMIN),
		INST_COMM = if_else(!is.na(id), verify_install_comment, INST_COMM),
		EXCL_REAS = if_else(!is.na(id), verify_misclass, EXCL_REAS)
	)
```
...
* [vancouver-bikeways-raw-v1.geojson](https://github.com/rrwen/recovr-infracycle/blob/main/data/vancouver-bikeways-raw-v1.geojson)
* [vancouver-bikeways-raw-v1.csv](https://github.com/rrwen/recovr-infracycle/blob/main/data/vancouver-bikeways-raw-v1.csv)
...
vanc_raw %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "vancouver-bikeways-raw-nonspatial-v1")
```
...
* [calgary-bikeways-raw-v1.geojson](https://github.com/rrwen/recovr-infracycle/blob/main/data/calgary-bikeways-raw-v1.geojson)
* [calgary-bikeways-raw-v1.csv](https://github.com/rrwen/recovr-infracycle/blob/main/data/calgary-bikeways-raw-v1.csv)
...
calg_raw %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "calgary-bikeways-raw-nonspatial-v1")
```
...
* [toronto-bikeways-raw-v1.geojson](https://github.com/rrwen/recovr-infracycle/blob/main/data/toronto-bikeways-raw-v1.geojson)
* [toronto-bikeways-raw-v1.csv](https://github.com/rrwen/recovr-infracycle/blob/main/data/toronto-bikeways-raw-v1.csv)
...
toron_raw %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "toronto-bikeways-raw-nonspatial-v1")
```
...
* [vancouver-bikeways-preprocess-v1.geojson](https://github.com/rrwen/recovr-infracycle/blob/main/data/vancouver-bikeways-preprocess-v1.geojson)
* [vancouver-bikeways-preprocess-v1.csv](https://github.com/rrwen/recovr-infracycle/blob/main/data/vancouver-bikeways-preprocess-v1.csv)
...
vanc_preprocess %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "vancouver-bikeways-preprocess-nonspatial-v1")
```
...
* [calgary-bikeways-preprocess-v1.geojson](https://github.com/rrwen/recovr-infracycle/blob/main/data/calgary-bikeways-preprocess-v1.geojson)
* [calgary-bikeways-preprocess-v1.csv](https://github.com/rrwen/recovr-infracycle/blob/main/data/calgary-bikeways-preprocess-v1.csv)
...
calg_preprocess %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "calgary-bikeways-preprocess-nonspatial-v1")
```
...
* [toronto-bikeways-preprocess-v1.geojson](https://github.com/rrwen/recovr-infracycle/blob/main/data/toronto-bikeways-preprocess-v1.geojson)
* [toronto-bikeways-preprocess-v1.csv](https://github.com/rrwen/recovr-infracycle/blob/main/data/toronto-bikeways-preprocess-v1.csv)
...
toron_preprocess %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "toronto-bikeways-preprocess-nonspatial-v1")
```
...
vanc %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "vancouver-bikeways-preprocess-filter-v1")
```
...
calg %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable(filename = "calgary-bikeways-preprocess-filter-v1")
```
...
toron %>%
	as.data.frame %>%
	select(-geometry) %>%
	datatable("filename = toronto-bikeways-preprocess-filter-v1")
```
