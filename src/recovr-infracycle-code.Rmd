...
#'
#' @param cities_list A list of lists, where each list contains the following structure defining the city mapping data and settings:
#' \itemize{
...
#' 
#' @return A list of lists, where each list has keys and values from \code{cities_list}, and the following additional keys:
#' \itemize{
...
map_infra <- function(
	...
	cities_prep <- prep_infra(cities_list)
