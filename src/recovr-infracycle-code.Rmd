...
vanc_plot_infra <- calc_yearly_adj_len(vanc) %>%
    plot_yearly_len(title = "Vancouver, Canada") +
    theme(plot.margin = unit(c(15, 5, 5, 5), "point"))
calg_plot_infra <-  calc_yearly_adj_len(calg) %>%
    plot_yearly_len(title = "Calgary, Canada")
toron_plot_infra <-  calc_yearly_adj_len(toron) %>%
    plot_yearly_len(title = "Toronto, Canada")
