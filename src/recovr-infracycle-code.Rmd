...
settings$static_basemap <- "https://server.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Light_Gray_Base/MapServer/tile/{z}/{y}/{x}"
...
```{r warning = FALSE, message = FALSE, fig.width = 8.5, fig.height = 9}
x <- map_infra(list(
	toronto = list(
		title = "Toronto, CA",
		data = toron,
