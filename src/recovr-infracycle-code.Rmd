...
3. Open RStudio and open the [src/src.Rproj](https://github.com/rrwen/recovr-infracycle/blob/main/src/src.Rproj)
...
5. In the R Console on the bottom pane, install the required R libraries using the code below
6. Click the `Run` drop down (top right of code pane) and click `Run All`
...
# Save geojson
vanc_raw %>%
	st_write("../data/vancouver-bikeways-raw-v1.geojson", delete_dsn = TRUE)
```
...
# Save geojson
vanc_preprocess %>%
	st_write("../data/vancouver-bikeways-preprocess-v1.geojson", delete_dsn = TRUE)
```
...
# Save geojson
# calg_preprocess %>%
# 	st_write("../data/calgary-bikeways-preprocess-v1.geojson", delete_dsn = TRUE)
```
